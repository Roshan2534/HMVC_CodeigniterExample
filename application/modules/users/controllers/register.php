...
class Register extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('confirm_password','Confirm Password','trim|required|min_length[7]|matches[password]');
        ...
        echo Modules::run('templates/default_layout',$data);
           ...
           {
               $this->session->set_flashdata('UserRegistered','You have registered Successfully kindly login..!!');
               redirect('login');
           }
        }
    }
